...
function Libxc.evaluate!(func::Functional, ::Union{Val{:lda},Val{:hyb_lda}}, rho::CuArray{Float64};
    ...
    @ccall libxc_gpu.xc_lda(pointer::Ptr{xc_func_type}, n_p::Csize_t, rho::CuPtr{Cdouble},
...
function Libxc.evaluate!(func::Functional, ::Union{Val{:gga},Val{:hyb_gga}}, rho::CuArray{Float64};
    ...
    @ccall libxc_gpu.xc_gga(
        pointer::Ptr{xc_func_type}, n_p::Csize_t, rho::CuPtr{Cdouble}, sigma::CuPtr{Cdouble},
        zk::CuPtr{Cdouble},
...
function Libxc.evaluate!(func::Functional, ::Union{Val{:mgga},Val{:hyb_mgga}}, rho::CuArray{Float64};
                         sigma::CuArray{Float64},
                         tau::OptCuArray=CU_NULL,
                         lapl::OptCuArray=CU_NULL,
                         zk::OptCuArray=CU_NULL,
    ...
    if Libxc.needs_tau(func) && tau === CU_NULL
        throw(ArgumentError("Functional $(func.identifier) requires tau."))
    end
    if Libxc.needs_laplacian(func) && lapl === CU_NULL
